...
import WaterDropGrid from './WaveEffect';
  ...
  return (
    <div name='home' className={`min-w-screen h-3/6 ${homeClass}`}>
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        <div className="">
        <h1 className={`text-5xl sm:text 7xl font-bold ${titleClass}`}> <WordRotate> Habib Rahman </WordRotate>  </h1>
        ...
        <Link to='work' smooth={true} duration={500} className={``}>
          <button className='group border-2 px-6 py-3 my-2 flex items-center hover:text-red-900 hover:border-pink-600'>
            View Projects 
            <p to='work' smooth={true} className='ml-2 group-hover:rotate-90 duration-300'><HiOutlineArrowNarrowRight /></p>
          </button>
        </Link>
        </div>
